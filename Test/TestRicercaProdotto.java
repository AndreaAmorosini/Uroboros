...
import java.net.URL;
public class TestRicercaProdotto {
  ...
  @Test
  public void ricercadiunprodotto() {
    driver.get("http://localhost:8080/Piattaforma_e-commerce_war/");
    driver.manage().window().setSize(new Dimension(1936, 1096));
    Actions actions = new Actions(driver);
    WebElement target = driver.findElement(By.className("searchDrop"));
    actions.moveToElement(target).perform();
    driver.findElement(By.name("searchTerm")).click();
    driver.findElement(By.name("searchTerm")).sendKeys("hardware");
    driver.findElement(By.cssSelector(".searchButton > .fa")).click();
    System.out.println("Ricerca Prodotto OK");
  }
}
